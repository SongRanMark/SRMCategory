...
Pod::Spec.new do |s|
  s.name             = 'SRMCategory'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SRMCategory.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/githubsr/SRMCategory'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'githubsr' => 'marksong@augmentum.com.cn' }
  s.source           = { :git => 'https://github.com/githubsr/SRMCategory.git', :tag => s.version.to_s }
